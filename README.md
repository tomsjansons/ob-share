...
- **`RegisterWorkflow` type error during build:** If you see a `ClassDecorator` mismatch around `RegisterWorkflow`, pull the latest changes where the decorator uses a constructor-compatible signature and cast.
